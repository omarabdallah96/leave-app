...
@section('content')
    <div class="max-w-full mx-auto sm:px-6 lg:px-8 py-10">
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Permissions Management</h2>
        ...
        <div class="overflow-x-auto">
            <div class="min-w-full bg-white dark:bg-gray-900 shadow-md rounded-lg overflow-hidden">
                <table class="min-w-full table-auto divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody
                        class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700 text-gray-700 dark:text-gray-200 text-sm">
                        @forelse ($permissions as $index => $permission)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                                <td class="px-6 py-4 whitespace-nowrap">{{ $index + 1 }}</td>
                                <td class="px-6 py-4 whitespace-nowrap font-semibold">{{ $permission->name }}</td>
