...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-10">
    <div class="flex justify-between items-center mb-8">
        <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-200">Create Leave Type</h2>
        ...
        <form action="{{ route('leave-types.store') }}" method="POST">
            ...
            <div class="px-6 py-8 space-y-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" class="mt-1 block w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:text-gray-200" required>
                </div>
